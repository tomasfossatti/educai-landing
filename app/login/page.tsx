...
export default function Login(){
  return <div className="shell"><div className="auth"><div className="card stack auth-card">
    <div className="auth-intro"><div className="eyebrow">Acceso a Educai</div><RectangularTextReveal>Ingresar</RectangularTextReveal><p>Volvé a tus cursos y continuá desde donde estabas.</p></div>
    <LoginForm/>
