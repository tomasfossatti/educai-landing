...
| RAG uses lexical chunk scoring instead of embeddings/vector DB. | MVP Implementation Decision | Validates contextual grounding with less infrastructure. | Replaceable behind `retrieveContext`; semantic recall is a known limitation. |
